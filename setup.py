...
dev_requirements = get_requires("conan/requirements_dev.txt")
...
setup(
    ...
    description='Promote Conan package to stable channel',

    # The project's main homepage.
    url='http://github.com/uilianries/conan-promote',
